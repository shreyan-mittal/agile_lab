        ...
        >
              ...
              {bullets.map((bullet, i) => {
                ...
                return (
                  <motion.div
                    ...
                    hover:bg-slate-900/70 hover:shadow-lg hover:shadow-blue-900/20 transform-gpu"
                  >
                    <motion.div
                      whileHover={{ rotate: 10 }}
                      transition={{ duration: 0.3 }}
                      className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 shadow-lg"
                    >
                      <Icon className="h-5 w-5 text-white" />
                    </motion.div>
                    <span className="pt-1.5 text-sm text-slate-300">{bullet.text}</span>
                  </motion.div>
                )
              })}
            </div>
          ...
          <div className="flex-1 lg:sticky lg:top-24">
            ...
            >
              ...
              <div className="absolute left-[3.25rem] top-[8.5rem] bottom-10 w-px overflow-hidden">
                <motion.div
                  initial={{ scaleY: 0 }}
                  whileInView={{ scaleY: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: 0.3 }}
                  className="h-full w-full origin-top bg-gradient-to-b from-blue-500 via-cyan-500 to-indigo-500"
                />
              </div>
                  ...
                  >
                    <div className="flex gap-4">
                      <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                        className={`relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br ${stage.gradient} shadow-lg`}
                        style={{ boxShadow: `0 0 20px ${stage.shadowColor}` }}
                      >
